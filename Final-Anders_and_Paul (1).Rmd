...
Admittedly, it appears as if poisonous and edible mushrooms can't be clustered quite so simply.
...
With the exception of a few clusters, these are pretty well separated by edibility now. Let's move on to some other clustering methods.
