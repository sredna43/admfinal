...
Theres some interesting stuff going on here especially with the gaps in the clusters, but they are pretty separated which is ideal. Without having names for our mushrooms it is admittedly difficult to tell which is which.

Just out of curiosity, let's look at something with only 3 or 4 clusters.
...
The separation isn't quite there yet.
